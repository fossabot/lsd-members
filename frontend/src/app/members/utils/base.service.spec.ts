...
describe('Members: base service', () => {
  ...
  it('clears the JWT if the request fails with a 401 error code (GET)', async(inject([Http, JwtService], (http: Http, jwtService: JwtService) => {
  ...
  it('clears the JWT if the request fails with a 401 error code (POST)', async(inject([Http, JwtService], (http: Http, jwtService: JwtService) => {
  ...
  it('clears the JWT if the request fails with a 401 error code (PUT)', async(inject([Http, JwtService], (http: Http, jwtService: JwtService) => {
